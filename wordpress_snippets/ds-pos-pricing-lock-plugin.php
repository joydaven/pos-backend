<?php
/**
 * Plugin Name: DS POS Pricing Lock
 * Description: Prevents WooCommerce from modifying DS POS order prices
 * Version: 1.0
 * Author: DS POS Team
 */
...
add_action('admin_notices', 'ds_pos_pricing_lock_notice');

function ds_pos_pricing_lock_notice() {
    if (current_user_can('manage_options')) {
        echo '<div class="notice notice-success"><p><strong>DS POS Pricing Lock:</strong> Plugin is active and protecting DS POS order pricing from automatic discounts.</p></div>';
    }
}

error_log("DS POS PRICING LOCK: Plugin loaded successfully");
?>
